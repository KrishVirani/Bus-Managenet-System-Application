...
import com.example.busmanagermentapplicationfinal.conductor.emergency_list;
...
public class driver_create_emergency_alert extends DriverBaseActivity {
    EditText etAlertMsg;
    Spinner  sp_bus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedUserId="FjRUjPm3I8KkmQDhAo4C";
                ...
                fusedLocationClient.getLastLocation()
                        .addOnSuccessListener(location -> {
                            if (location != null) {
                                ...
                                Toast.makeText(driver_create_emergency_alert.this, "Could not fetch location", Toast.LENGTH_SHORT).show();
                            }
                        })
                        .addOnFailureListener(e -> {
                            Toast.makeText(driver_create_emergency_alert.this, "Location error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        });
            }
        });
